...
/***************************************************************************
 * REVISION HISTORY:
 * $Log: PolicyEvaluator.cc,v $
 * Revision 1.12  2007/07/08 03:37:56  trey
 * when useEvaluationCache=1, now print log scores for batches instead of scores for individual runs; this is needed to get valid statistics
 *
